<template>   
    <section class="py-10 2xl:py-20 overflow-hidden">
          ...
          <div class="flex flex-wrap items-center -mx-10">
            <div class="w-full lg:w-1/2 px-10">
              <div class="px-6 lg:px-20 py-12 lg:py-24 bg-white shadow-2xl rounded-lg">
                <form action="#">
                  <h3 class="mb-10 text-2xl font-bold font-heading">Log into your Account</h3>
                  <div class="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-full">
                    ...
                    <input v-model="email" class="w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="example@shuffle.dev">
                  </div>
                  <div class="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-full">
                    <span class="inline-block pr-3 border-r border-gray-50">
                    ...
                    <input v-model="password" class="w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="password" placeholder="Password">
                  </div>
                  <button @click.prevent="login()" class="py-4 w-full mt-10 bg-custom-500 text-white font-bold rounded-full transition duration-200">Get started</button>
                </form>
              </div>
            </div>
            <div class="w-full lg:w-1/2 px-10 mb-16 lg:mb-0 order-first lg:order-last">
              <div class="max-w-md">
                <span class="text-lg text-custom-500 font-bold">Register Account</span>
                <h2 class="mt-8 mb-12 text-5xl font-bold font-heading">Lorem ipsum dolor sit amet consectetur.</h2>
